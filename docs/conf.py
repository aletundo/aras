# -*- coding: utf-8 -*-
#
# ARAS documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'aras', u'ARAS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ARAS', u'ARAS Documentation',
     author, 'ARAS', 'One line description of project.',
     'Miscellaneous'),
]
